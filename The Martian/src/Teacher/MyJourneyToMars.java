...
public class MyJourneyToMars extends JourneyToMars {
	...
	public static void main(String [] args) {
    	...
    	MyOrbit earth2MarsGA = new MyOrbit("Earth To Mars (Gravity Assist)", Mission.aMax_toEarth, Mission.eMin);
    	earth2MarsGA.setOmega(180.0); //return trip
    	earth2MarsGA.setDestinationOrbit(earth);
    	
		//launch the app with a new mission
		j2m.launch(new MyMission(earth, mars, earth2Mars, mars2Earth, earth2MarsGA));
	}
